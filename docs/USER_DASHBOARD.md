...
Semua file di modul ini dilindungi guard sesi standar. Tabel utama: `articles`, `publisher_quota`, `llm_settings` (satu baris config aktif, lihat `docs/ADMIN_PANEL.md` Modul B), `idea_article`.
