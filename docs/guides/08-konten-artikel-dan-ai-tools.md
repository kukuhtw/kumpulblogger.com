...
> Navigasi: [Runbook operasional](../OPERATIONS_RUNBOOK.md) · [Dashboard user](../reference/USER_DASHBOARD.md) · [Panel admin](../reference/ADMIN_PANEL.md) · [Database](./12-skema-database.md)

> Generator konten pada dokumen ini berbeda dari produk chat dan sponsored
> retrieval. Lihat [Knowledge Commerce Engine (KCE)](./13-knowledge-commerce-engine.md).
