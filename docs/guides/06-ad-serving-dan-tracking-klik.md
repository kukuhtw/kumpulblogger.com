...
> Navigasi: [Runbook validasi klik](../OPERATIONS_RUNBOOK.md#10-validasi-klik-hingga-revenue) · [Publisher](./03-alur-publisher.md) · [Advertiser](./04-alur-advertiser.md) · [Cronjob](../operations/CRONJOB_JOBS.md)
