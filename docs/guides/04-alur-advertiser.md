...
> Navigasi: [Runbook operasional](../OPERATIONS_RUNBOOK.md#8-uji-advertiser) · [Publisher](./03-alur-publisher.md) · [Pembayaran](./07-pembayaran-dan-revenue-share.md) · [Dashboard user](../reference/USER_DASHBOARD.md)
