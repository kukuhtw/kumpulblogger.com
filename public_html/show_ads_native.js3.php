...
foreach ($ads as $ad) {
    ...
    echo <<<EOT
    document.write(`<div class='ads-item$active_class'>
        ...
        <div>
            ...
            <small><em>Ad Network: <a href='$ads_providers_domain_url_safe' target='_blank'>$ads_providers_name_safe</a></em></small>
        </div>
    </div>`);
    EOT;
}
