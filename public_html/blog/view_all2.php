    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <script
          ...
          src="<?php echo $this_providers_domain_url; ?>/show_ads_native_landscape.js.php?pubId=<?php echo $pubId; ?>&pubProvName=<?php echo urlencode($this_providers_name); ?>&maxads=1&column=1">
        </script>
