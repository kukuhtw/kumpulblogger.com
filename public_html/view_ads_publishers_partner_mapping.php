...
// Table: mapping_advertisers_ads_publishers_site_from_partners
// Prepare SQL query for main ads data
$sql = "SELECT * FROM mapping_advertisers_ads_publishers_site_from_partners 
...
$count_sql = "SELECT COUNT(*) FROM mapping_advertisers_ads_publishers_site_from_partners 
              WHERE owner_advertisers_id = ? AND ads_providers_domain_url = ?";
if ($local_ads_id) {
...
<?php
$url_report_local = $this_providers_domain_url."/data/clicks_local_detail.php?local_ads_id=".$local_ads_id."&click_time=&ads_providers_domain_url=".$this_providers_domain_url;

$url_report_partner = $this_providers_domain_url."/data/clicks_partner_detail.php?local_ads_id=".$local_ads_id."&click_time=&ads_providers_domain_url=".$this_providers_domain_url;
...
<p><strong>published_date:  </strong> <?php echo $published_date; ?></p>
        ...
        <div class="text-end mb-3">
            <a href="view_ads_publishers_partner_mapping.php?sort=rate_text_ads&order=<?php echo $sort_order === 'ASC' ? 'desc' : 'asc'; ?><?php echo $local_ads_id ? '&local_ads_id=' . $local_ads_id : ''; ?>" class="btn btn-secondary">
                Sort by Rate (<?php echo $sort_order === 'ASC' ? 'Desc' : 'Asc'; ?>)
            </a>
            <a href="view_ads_publishers_partner_mapping.php?sort=budget_per_click_textads&order=<?php echo $sort_order === 'ASC' ? 'desc' : 'asc'; ?><?php echo $local_ads_id ? '&local_ads_id=' . $local_ads_id : ''; ?>" class="btn btn-secondary">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p><strong>Publishers site local id:</strong> <?php echo htmlspecialchars($row['publishers_site_local_id']); ?></p>
                                         ...
                                         <p><strong>local_mapping_id:</strong> <?php echo htmlspecialchars($row['local_mapping_id']); ?></p>
            ...
            <div class="modal fade" id="editApprovalModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="editApprovalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="update_approval_advertiser_partner.php" method="POST">
                            <div class="modal-body">
                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                <input type="hidden" name="local_ads_id" value="<?php echo $local_ads_id; ?>">
                                <input type="hidden" name="local_mapping_id" value="<?php echo $row['local_mapping_id'] ; ?>">

                                <input type="hidden" name="pubs_providers_domain_url" value="<?php echo $row['pubs_providers_domain_url'] ; ?>">
                                 <input type="hidden" name="ads_providers_domain_url" value="<?php echo $row['ads_providers_domain_url'] ; ?>">

                            

                                <br>ads_providers_domain_url:
                                <br><?php echo $row['ads_providers_domain_url'] ?>
                                
                                <br>pubs_providers_domain_url:
                                <br><?php echo $row['pubs_providers_domain_url'] ?>
                                
                                <br>local_mapping_id:<?php echo $row['local_mapping_id'] ?>
