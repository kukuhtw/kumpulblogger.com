...
$count_stmt = $conn->prepare("SELECT COUNT(*) AS total FROM advertisers_ads_partners WHERE ispublished = 1 AND (title_ads LIKE ? OR description_ads LIKE ?)");
...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Advertisers' Partner</h1>
