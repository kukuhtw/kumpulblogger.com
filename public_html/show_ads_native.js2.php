...
foreach ($ads as $ad) {
    ...
    $description_ads_safe = ad_js_escape($ad['description_ads']);
    ...
    echo <<<EOT
    document.write(`<div class='ads-item clearfix$active_class'>
        <a href='$click_url_safe' target='_blank'><img src='$image_url_safe' alt='Ad Image'></a>
        <div>
            <a href='$click_url_safe' target='_blank'>$title_ads_safe</a><br>
