...
<body>
    <div class="container">
        <div class="card">
            ...
            <h2 class="text-center mb-4">Buat Artikel dengan AI</h2>
...
<div class="mb-3">
    ...
    <br>☝️ nggak ada ide ? ☝️ klik button diatas ini ☝️
</div>
                    ...
                    <div class="mb-3">
                        <label for="focus" class="form-label">Fokus Utama Artikel</label>
                        <input type="text" class="form-control" id="focus" name="focus" placeholder="Contoh: dampak Hermes Agent terhadap workflow developer Indonesia" required>
                        <div class="form-text">Tuliskan satu sudut pembahasan utama agar artikel tidak melebar.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Masukkan fakta, kutipan, angka, atau catatan penting yang diambil dari sumber.</div>
                    </div>

                    <div class="alert alert-light border mb-3">
                        <i class="fas fa-search me-1"></i> AI akan mencari dan mencantumkan minimal dua sumber web yang relevan setelah Anda mengonfirmasi fokus artikel.
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="tone" name="tone">
                            ...
                            <option value="gaya anak anak">Gaya Anak Anak</option>
                            <option value="gaya gaul">Gaya Gaul</option>
                            <option value="gaya dosen">Gaya Dosen</option>
                            <option value="gaya anak muda">Gaya Anak Muda</option>
                            <option value="gaya orang tua">Gaya Orang Tua</option>

                            <option value="Gaya Mahasiswa Gondrong , Penuh Analogi">Gaya Mahasiswa Gondrong , Penuh Analogi</option>

                            <option value="Gaya Filsuf penuh pertanyaan">Gaya Filsuf penuh pertanyaan</option>

                            <option value="gaya politikus, Penuh janji">Gaya Politikus, Penuh janji</option>

                            <option value="Obrolan warung kopi">Obrolan warung kopi</option>
                            ...
                            <option value="Horor Mencekam">Horor Mencekam</option>
  ...
  View Article
    ...
    <script>
            ...
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    quotaInfo.innerHTML = `
                        ...
                        ${data.data.used_quota} dari ${data.data.total_quota} artikel. Sisa quota: ${remainingQuota} artikel. Bila terjadi error ketika submit article, kemungkinan karena double submit. Klik View Article.
                    `;
        ...
        function generateArticle() {
            ...
            if (!focus) {
                showAlert('warning', 'Tentukan fokus utama artikel terlebih dahulu.');
                return;
            }

            const confirmed = window.confirm(
                'Konfirmasi arah artikel:\n\n' +
                'Topik: ' + topic + '\n' +
                'Fokus: ' + focus + '\n' +
                'Sumber: AI akan mencari minimal 2 sumber web\n\n' +
                'Lanjutkan membuat artikel dengan fokus ini?'
            );
            if (!confirmed) return;
            ...
            showProgress('Generating article...Bila terjadi error , kemungkinan terjadi double submit... klik view artikel untuk check..apakah artikel berhasil dibuat..');
