...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['prefill'])) {
    ...
    // Hanya untuk mengisi form, bukan percobaan login sungguhan.
    $prefill_email = $_POST['email'] ?? '';
    $prefill_password = $_POST['password'] ?? '';
    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST" class="needs-validation" novalidate>
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="<?php echo htmlspecialchars($prefill_email); ?>" required>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="password" name="password" value="<?php echo htmlspecialchars($prefill_password); ?>" required>
