<!-- Toggle Button -->
<button class="toggle-btn" type="button" onclick="toggleSidebar()" aria-label="Buka atau tutup menu">&#9776;</button>
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li><a href="manage_writer_quotas.php"><i class="fas fa-pen"></i> Quota Menulis</a></li>
    ...
    <li><a href="manage_ads_partner.php"><i class="fas fa-ad"></i> Manage Ads Partners</a></li>
        ...
        <li><a href="latest_recognized_clicks.php"><i class="fas fa-mouse-pointer"></i> Klik Terakhir Diakui</a></li>
        <li><a href="top_active_publishers.php"><i class="fas fa-chart-line"></i> Blog Teraktif Menampilkan Iklan</a></li>
        <li><a href="publisher_click_forensics.php"><i class="fas fa-search-dollar"></i> Forensik Klik Publisher</a></li>
