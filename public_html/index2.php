                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <a class="nav-link" href="https://kumpulblogger.com/white_label/">Info detail</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
...
========================================== -->
<section class="py-5">
    <h2 class="section-heading text-uppercase text-center mb-4">Artikel Terbaru</h2>
                ...
                <section class="py-5">
                    <div class="container">
                        <div class="text-center">
                            ...
                            <p class="text-muted">White label dalam jaringan periklanan KumpulBlogger adalah solusi bagi mereka yang ingin memiliki platform pay-per-click dengan merek sendiri, tetapi tetap menggunakan kode dari platform KumpulBlogger.</p><p class="text-muted">
                            <a class="nav-link" href="https://kumpulblogger.com/white_label/" style="color: blue;">Info detail</a>
