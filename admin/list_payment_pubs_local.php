...
$sql = "SELECT * FROM payment_local_pubs ORDER BY payment_date DESC LIMIT ?, ?";
...
$count_sql = "SELECT COUNT(*) AS total FROM payment_local_pubs";
...
<head>
    ...
    <title>Payment Local Pubs List</title>
    <!-- Bootstrap CSS -->
            ...
            <?php if ($total_pages > 1): ?>
                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <li class="page-item <?php echo ($i == $page) ? 'active' : ''; ?>">
                        <a class="page-link" href="list_payment_pubs_local.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>
            <?php endif; ?>
        </ul>
