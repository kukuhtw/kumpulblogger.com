...
Sumber: `sql/kumpulbl_kbc_hanya_structure.sql`. Dokumen ini menjelaskan **peran bisnis** tiap tabel (bukan dump kolom mentah), dikelompokkan per domain. Untuk struktur kolom lengkap, lihat file SQL langsung (nomor baris `CREATE TABLE` dicantumkan).
